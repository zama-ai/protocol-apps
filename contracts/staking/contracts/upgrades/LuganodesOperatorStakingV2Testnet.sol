...
/**
 * @title LuganodesOperatorStakingV2Testnet
 ...
 */
contract LuganodesOperatorStakingV2Testnet is OperatorStaking {
    /**
     * @notice Returns the correct name of the token.
     * @return The name "Luganodes Staked ZAMA (Coprocessor)".
     */
    function name() public pure override returns (string memory) {
        return "Mock Luganodes Staked ZAMA (Coprocessor)";
    }
    ...
    function symbol() public pure override returns (string memory) {
        return "stZAMA-Mock-Luganodes-Coprocessor";
    }
}
