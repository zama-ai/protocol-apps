 ...
 * returns successfully with no data, and so does `paused()`. Used to prove the pauser does not report a target as
 * paused just because the call did not revert. Test-only.
 */
