...
// Example usage:
// npx hardhat task:encryptInput --input-value 600000 --user-address 0x... --contract-address 0x... --encrypted-type euint64 --network mainnet
// npx hardhat task:encryptInput --input-value true --user-address 0x...--contract-address 0x... --encrypted-type ebool  --network mainnet
// npx hardhat task:encryptInput --input-value 0xc0ffee254729296a45a3885639AC7E10F9d54979 --user-address 0x... --contract-address 0x... --encrypted-type eaddress --network mainnet
